...
class TestTallyExport(TestCase):
	...
	def test_doctype_parameter_is_parsed_and_validated(self):
		...
		with patch(
			"express_tally.integrations.tally_export.frappe.throw",
			side_effect=frappe.ValidationError,
		), patch(
			"express_tally.integrations.tally_export._",
	...
	def test_sales_order_voucher_uses_tally_order_structure(self):
		...
		with patch(
			"express_tally.integrations.tally_export.formatdate",
			return_value="20-Aug-2026",
		):
