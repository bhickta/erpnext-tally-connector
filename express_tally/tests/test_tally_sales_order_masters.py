...
from express_tally.integrations.tally_export import (
	_ancestor_names,
	_master_payload,
...
class TestSalesOrderMasterExport(TestCase):
	...
	@patch("express_tally.integrations.tally_export._company_abbr", return_value="TC")
	@patch("express_tally.integrations.tally_export._export_items", return_value=[])
	@patch("express_tally.integrations.tally_export._export_warehouses", return_value=[])
	@patch("express_tally.integrations.tally_export._export_item_groups", return_value=[])
	@patch("express_tally.integrations.tally_export._export_uoms", return_value=[])
	@patch("express_tally.integrations.tally_export._export_parties", return_value=[])
	@patch("express_tally.integrations.tally_export._export_accounts", return_value=[])
	@patch("express_tally.integrations.tally_export.frappe.get_all")
	@patch("express_tally.integrations.tally_export._get_sales_orders")
